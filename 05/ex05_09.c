 ...
 *     scale it represents. Here is the formula for converting Fahrenheit to Celsius:
 ...
 *     The Temperatures() function should use const to create symbolic representation
