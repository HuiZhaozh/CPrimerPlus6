 ...
 * 日期： 2021-10-12
 * 页码： 第437页
 * 目的： Write a program that takes two command-line arguments. The first is a string; the
 ...
 *       use fgets() instead of getc(). Use the standard C library function strstr() (briefly described
 *       in exercise 7 of Chapter 11) to search each line for the string. Assume no lines are longer than
 *       255 characters.
 */
const char * errmesg[] = {
